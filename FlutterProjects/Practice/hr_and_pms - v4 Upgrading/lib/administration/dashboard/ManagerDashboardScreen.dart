...
class _ManagerDashboardScreenState extends State<ManagerDashboardScreen> {
  ...
  final List<Map<String, dynamic>> _navItems = [
    {'icon': Icons.home, 'label': 'Home', 'screen': AttendanceReportScreen()},
    {'icon': Icons.work_off, 'label': 'Leave', 'screen': LeaveManagementScreen()},
  ...
  Widget _buildDashboardGrid(BuildContext context) {
    final List<Map<String, dynamic>> features = [
      {'icon': Icons.access_time, 'label': 'Attendance', 'screen': AttendanceReportScreen()},
      {'icon': Icons.manage_history_outlined, 'label': 'Apply Leave', 'screen': LeaveManagementScreen()},
      {'icon': Icons.calculate_outlined, 'label': 'Apply Advance', 'screen':AdvanceSalaryManagementScreen()},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Manager Dashboard', style: TextStyle( fontSize: 40,
