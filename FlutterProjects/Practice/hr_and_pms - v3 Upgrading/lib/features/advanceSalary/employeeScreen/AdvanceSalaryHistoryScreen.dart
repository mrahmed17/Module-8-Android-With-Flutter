...
class AdvanceSalaryHistoryScreen extends StatefulWidget {
  ...
  const AdvanceSalaryHistoryScreen({Key? key, required this.userId}) : super(key: key);
...
class _AdvanceSalaryHistoryScreenState extends State<AdvanceSalaryHistoryScreen> {
  ...
  void initState() {
    super.initState();
    // Fetch the advance salary history for the given user
    _advanceSalaryHistory = _advanceSalaryService.getAdvanceSalaries(widget.userId);
  }
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text('Status: ${application.status.toShortString()}'),
                      ],
                    ),
                    trailing: Icon(
