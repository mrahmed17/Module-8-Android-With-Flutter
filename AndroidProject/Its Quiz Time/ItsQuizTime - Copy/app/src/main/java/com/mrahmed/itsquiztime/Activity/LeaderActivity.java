...
public class LeaderActivity extends AppCompatActivity {
    ...
    private List<UserModel> loadData() {
        ...
        users.add(new UserModel(1, "Raju", "person3", 4521));
        users.add(new UserModel(2, "Ahmed", "person6", 4521));
        users.add(new UserModel(3, "Rezvi", "person2", 4521));
        users.add(new UserModel(4, "Nusrat", "person8", 4521));
        users.add(new UserModel(5, "Towhid", "person4", 4521));
        users.add(new UserModel(6, "Shabab", "person6", 4521));
        users.add(new UserModel(7, "Shamima", "person7", 4521));
        users.add(new UserModel(8, "Neyamul", "person2", 4521));
        users.add(new UserModel(9, "Rafiqul", "person4", 4521));
        users.add(new UserModel(10, "Sanaullah", "person3", 4521));
        users.add(new UserModel(11, "Nirjash", "person2", 4521));
        users.add(new UserModel(12, "Najmul", "person9", 4521));
